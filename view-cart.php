...
<link rel="stylesheet" href="css/mycart.css?v3.1">
    ...
    <div class="child-cart-container">
        ...
        <div class="cart-info-container">
            ...
            <section class="item-button">
                ...
                <h2 class="all-items">ALL ITEMS (<?= count($_SESSION['cart']) ?>)</h2>

                <form action="" method="post">
                    <button type="submit" class="action-delete-all-btn">
                        Delete All
                    </button>
                </form>
        ...
        <div class="order-cash-container">
            ...
            <div class="order-summary-container">
                ...
                <form action="" method="post">
                    ...
                    <button type="submit" class="checkout-btn">Checkout Now (<?php echo $totalQuantity; ?>)</button>
                </form>
            </div>
        ...
        <div class="order-cash-container">
            ...
            <div class="order-summary-container">
                ...
                <div class="checkout-container">
                    ...
                    <button type="button" class="checkout-btn">Checkout Now (<?php echo $totalQuantity; ?>)</button>
